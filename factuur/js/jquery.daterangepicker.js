...
(function($)
{
    ...
    $.dateRangePickerLanguages =
    {
        ...
        'nl':
        {
            ...
            'next-month':'Maand',
            'next-year':'Jaar',
            'less-than' : 'Date range mag niet meer dan %d dagen zijn',
            'more-than' : 'Date range mag niet minder dan %d dagen zijn',
            'default-more' : 'Selecteer aub een datum langer dan %d dagen',
            'default-single' : 'Selecteer aub een datum',
            'default-less' : 'Selecteer aub een date range korter dan %d dagen',
            'default-range' : 'Selecteer aub een datum tussen %d en %d dagen',
            'default-default': 'Selecteer aub een datum'
        }
    };
